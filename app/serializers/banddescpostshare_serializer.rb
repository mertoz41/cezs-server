class BanddescpostshareSerializer < ActiveModel::Serializer
  ...
  attributes :id, :clip, :description, :bandname, :bandpicture, :created_at, :share_count, :band_id, :comment_count, :banddescpost_id, :thumbnail
